export default {
  ...
  'menu.basicinfo.basicinfomanage': '基本信息维护',
  'menu.basicinfo.modifyhis': '岗位变更记录',
  'menu.basicinfo.markhismanage': '积分管理',
  'menu.performanceinfo': '考核信息管理',
  'menu.performanceinfo.indicatorsmanage': '考核指标明细维护',
  'menu.performanceinfo.relationship': '岗位与考核指标关系维护',
  'menu.performanceinfo.staffperformance': '人员考核信息',
  'menu.performanceinfo.orgperformance': '机构考核信息',
};
